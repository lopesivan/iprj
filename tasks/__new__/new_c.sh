...
#'<,'>!fmt -w 60   formatador
cat <<-EOF
Usage: iprj new c [OPTION]...

OPTIONS
    ccls     - Gera os arquivos ‘.ccls’ e ‘.ccls-root’ de controle
    init/yml - Gera YML de inicializaçao do template CHEETAH
    save     - Salva o processamento em arquivo
    cmake    - Gera ‘CMakeLists.txt’ para cansi
...
declare -A templates
templates[1]="${HOME}/developer/template-code/w-new-c"
